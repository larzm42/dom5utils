...
public class Starts {
	public static final long ITEM = 0x01157ca0l;
	...
	public static final long MONSTER = 0x011e3c88l;
	...
	public static final long MONSTER_MAGIC = 0x015a32b8l;
	public static final long ITEM_AND_MONSTER_DESC = 0x00224578l;
	public static final long ITEM_AND_MONSTER_DESC_INDEX = 0x0037f8f0l;
	
	public static final long MONSTER_TRS_INDEX = 0x0001ac1c;
	
	public static final long ITEM_TRS_INDEX = 0x0000243cl;

	public static final long SITE = 0x01466538l;
	...
	public static final long NAMES = 0x00fe09ecl;
	public static final long FIXED_NAMES = 0x011286f0l;
	public static final int NAMES_COUNT = 161;
	
	public static final long SPELL = 0x014d03b8l;
	public static final long SPELL_SIZE = 216l;

	public static final long SPELL_DESC = 0x00393170l;
	public static final long SPELL_DESC_INDEX = 0x003dec20l;

	public static final long EVENT = 0x003e6a70l;
	public static final long EVENT_SIZE = 1728l;
	
	public static final long MERCENARY = 0x011b1082l;
	public static final long MERCENARY_SIZE = 312l;

	public static final long ARMOR = 0x001fd240l;
	public static final long ARMOR_SIZE = 104l;

	public static final long WEAPON = 0x015c9e88l;
	public static final long WEAPON_SIZE = 112l;
	
	public static final long NATION = 0x00eaa730l;
