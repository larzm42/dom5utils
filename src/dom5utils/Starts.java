...
public class Starts {
	public static final long ITEM = 0x0115bf98l;
	...
	public static final long MONSTER = 0x011e80c8l;
	...
	public static final long MONSTER_MAGIC = 0x015a7748l;
	public static final long ITEM_AND_MONSTER_DESC = 0x00227378l;
	public static final long ITEM_AND_MONSTER_DESC_INDEX = 0x00382668l;
	
	public static final long MONSTER_TRS_INDEX = 0x0001ac1c;
	
	public static final long ITEM_TRS_INDEX = 0x0000243cl;

	public static final long SITE = 0x0146a9c8l;
	...
	public static final long NAMES = 0x00fe37d4l;
	public static final long FIXED_NAMES = 0x0112b4d8l;
	public static final int NAMES_COUNT = 161;
	
	public static final long SPELL = 0x014d4848l;
	public static final long SPELL_SIZE = 216l;

	public static final long SPELL_DESC = 0x00395ee8l;
	public static final long SPELL_DESC_INDEX = 0x003e1998l;

	public static final long EVENT = 0x003e97e8l;
	public static final long EVENT_SIZE = 1728l;
	
	public static final long MERCENARY = 0x011b5422l;
	public static final long MERCENARY_SIZE = 312l;

	public static final long ARMOR = 0x001ffe40l;
	public static final long ARMOR_SIZE = 104l;

	public static final long WEAPON = 0x015ce2e8l;
	public static final long WEAPON_SIZE = 112l;
	
	public static final long NATION = 0x00ead518l;
