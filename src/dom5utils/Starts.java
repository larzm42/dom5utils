...
public class Starts {
	public static final long ITEM = 0x01158828l;
	...
	public static final long MONSTER = 0x011e4890l;
	...
	public static final long MONSTER_MAGIC = 0x015a3ec0l;
	public static final long ITEM_AND_MONSTER_DESC = 0x00224fe0l;
	public static final long ITEM_AND_MONSTER_DESC_INDEX = 0x00380358l;
	
	public static final long MONSTER_TRS_INDEX = 0x0001ac1c;
	
	public static final long ITEM_TRS_INDEX = 0x0000243cl;

	public static final long SITE = 0x01467140l;
	...
	public static final long NAMES = 0x00fe148cl;
	public static final long FIXED_NAMES = 0x01129190l;
	public static final int NAMES_COUNT = 161;
	
	public static final long SPELL = 0x014d0fc0l;
	public static final long SPELL_SIZE = 216l;

	public static final long SPELL_DESC = 0x00393bd8l;
	public static final long SPELL_DESC_INDEX = 0x003df688l;

	public static final long EVENT = 0x003e74d8l;
	public static final long EVENT_SIZE = 1728l;
	
	public static final long MERCENARY = 0x011b1c5al;
	public static final long MERCENARY_SIZE = 312l;

	public static final long ARMOR = 0x001fdc40l;
	public static final long ARMOR_SIZE = 104l;

	public static final long WEAPON = 0x015caa60l;
	public static final long WEAPON_SIZE = 112l;
	
	public static final long NATION = 0x00eab1d0l;
