...
public class Starts {
	public static final long ITEM = 0x01146498l;
	...
	public static final long MONSTER = 0x011d1c98l;
	...
	public static final long MONSTER_MAGIC = 0x01590a20l;
	public static final long ITEM_AND_MONSTER_DESC = 0x00218c30l;
	public static final long ITEM_AND_MONSTER_DESC_INDEX = 0x0036f460l;
	
	public static final long MONSTER_TRS_INDEX = 0x0001a7e4l;
	
	public static final long ITEM_TRS_INDEX = 0x0000240cl;

	public static final long SITE = 0x01453ca0l;
	...
	public static final long NAMES = 0x00fcf794l;
	public static final long FIXED_NAMES = 0x011174a8l;
	public static final int NAMES_COUNT = 161;
	
	public static final long SPELL = 0x014bdb20l;
	public static final long SPELL_SIZE = 216l;

	public static final long SPELL_DESC = 0x00382ce0l;
	public static final long SPELL_DESC_INDEX = 0x003cdba0l;

	public static final long EVENT = 0x003d59f0l;
	public static final long EVENT_SIZE = 1728l;
	
	public static final long MERCENARY = 0x0119f522l;
	public static final long MERCENARY_SIZE = 312l;

	public static final long ARMOR = 0x001f1a40l;
	public static final long ARMOR_SIZE = 104l;

	public static final long WEAPON = 0x015b7338l;
	public static final long WEAPON_SIZE = 112l;
	
	public static final long NATION = 0x00e994f0l;
