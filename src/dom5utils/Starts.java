...
public class Starts {
	public static final long ITEM = 0x011498e8l;
	...
	public static final long MONSTER = 0x011d5488l;
	...
	public static final long MONSTER_MAGIC = 0x015944a8l;
	public static final long ITEM_AND_MONSTER_DESC = 0x00219e70l;
	public static final long ITEM_AND_MONSTER_DESC_INDEX = 0x00372758l;
	
	public static final long MONSTER_TRS_INDEX = 0x0001aaccl;
	
	public static final long ITEM_TRS_INDEX = 0x00002424l;

	public static final long SITE = 0x01457728l;
	...
	public static final long NAMES = 0x00fd2b94l;
	public static final long FIXED_NAMES = 0x0111a8a0l;
	public static final int NAMES_COUNT = 161;
	
	public static final long SPELL = 0x014c15a8l;
	public static final long SPELL_SIZE = 216l;

	public static final long SPELL_DESC = 0x00385fd8l;
	public static final long SPELL_DESC_INDEX = 0x003d0f88l;

	public static final long EVENT = 0x003d8dd8l;
	public static final long EVENT_SIZE = 1728l;
	
	public static final long MERCENARY = 0x011a2acal;
	public static final long MERCENARY_SIZE = 312l;

	public static final long ARMOR = 0x001f2c40l;
	public static final long ARMOR_SIZE = 104l;

	public static final long WEAPON = 0x015badf8l;
	public static final long WEAPON_SIZE = 112l;
	
	public static final long NATION = 0x00e9c8d8l;
