...
public class Starts {
	public static final long ITEM = 0x01147700l;
	...
	public static final long MONSTER = 0x011d30c8l;
	...
	public static final long MONSTER_MAGIC = 0x01591ee0l;
	public static final long ITEM_AND_MONSTER_DESC = 0x00219c70l;
	public static final long ITEM_AND_MONSTER_DESC_INDEX = 0x00370588l;
	
	public static final long MONSTER_TRS_INDEX = 0x0001a7e4l;
	
	public static final long ITEM_TRS_INDEX = 0x0000240cl;

	public static final long SITE = 0x01455160l;
	...
	public static final long NAMES = 0x00fd09acl;
	public static final long FIXED_NAMES = 0x011186c0l;
	public static final int NAMES_COUNT = 161;
	
	public static final long SPELL = 0x014befe0l;
	public static final long SPELL_SIZE = 216l;

	public static final long SPELL_DESC = 0x00383e08l;
	public static final long SPELL_DESC_INDEX = 0x003cedb8l;

	public static final long EVENT = 0x003d6c08l;
	public static final long EVENT_SIZE = 1728l;
	
	public static final long MERCENARY = 0x011a08e2l;
	public static final long MERCENARY_SIZE = 312l;

	public static final long ARMOR = 0x001f2a40l;
	public static final long ARMOR_SIZE = 104l;

	public static final long WEAPON = 0x015b8828l;
	public static final long WEAPON_SIZE = 112l;
	
	public static final long NATION = 0x00e9a708l;
