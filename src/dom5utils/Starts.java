...
public class Starts {
	public static final long ITEM = 0x01158e28l;
	...
	public static final long MONSTER = 0x011e4f58l;
	...
	public static final long MONSTER_MAGIC = 0x015a45a8l;
	public static final long ITEM_AND_MONSTER_DESC = 0x00225560l;
	public static final long ITEM_AND_MONSTER_DESC_INDEX = 0x003808d0l;
	
	public static final long MONSTER_TRS_INDEX = 0x0001ac1c;
	
	public static final long ITEM_TRS_INDEX = 0x0000243cl;

	public static final long SITE = 0x01467828l;
	...
	public static final long NAMES = 0x00fe1a3cl;
	public static final long FIXED_NAMES = 0x01129740l;
	public static final int NAMES_COUNT = 161;
	
	public static final long SPELL = 0x014d16a8l;
	public static final long SPELL_SIZE = 216l;

	public static final long SPELL_DESC = 0x00394150l;
	public static final long SPELL_DESC_INDEX = 0x003dfc00l;

	public static final long EVENT = 0x003e7a50l;
	public static final long EVENT_SIZE = 1728l;
	
	public static final long MERCENARY = 0x011b22b2l;
	public static final long MERCENARY_SIZE = 312l;

	public static final long ARMOR = 0x001fe040l;
	public static final long ARMOR_SIZE = 104l;

	public static final long WEAPON = 0x015cb148l;
	public static final long WEAPON_SIZE = 112l;
	
	public static final long NATION = 0x00eab780l;
