...
public class Starts {
	public static final long ITEM = 0x01136a28l;
	...
	public static final long MONSTER = 0x011c1ad0l;
	...
	public static final long MONSTER_MAGIC = 0x015804a0l;
	public static final long ITEM_AND_MONSTER_DESC = 0x002161c8l;
	public static final long ITEM_AND_MONSTER_DESC_INDEX = 0x003657c0l;
	
	public static final long MONSTER_TRS_INDEX = 0x0001a1b4l;
	
	public static final long ITEM_TRS_INDEX = 0x00002400l;

	public static final long SITE = 0x01443720l;
	...
	public static final long NAMES = 0x00fc0624l;
	public static final long FIXED_NAMES = 0x01107fe0l;
	public static final int NAMES_COUNT = 161;
	
	public static final long SPELL = 0x014ad5a0l;
	public static final long SPELL_SIZE = 216l;

	public static final long SPELL_DESC = 0x00374220l;
	public static final long SPELL_DESC_INDEX = 0x003bead8l;

	public static final long EVENT = 0x003c6928l;
	public static final long EVENT_SIZE = 1728l;
	
	public static final long MERCENARY = 0x0118f7a2l;
	public static final long MERCENARY_SIZE = 312l;

	public static final long ARMOR = 0x001ef040l;
	public static final long ARMOR_SIZE = 104l;

	public static final long WEAPON = 0x015a6c28l;
	public static final long WEAPON_SIZE = 112l;
	
	public static final long NATION = 0x00e8a380l;
